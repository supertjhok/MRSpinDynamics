...
function [macq]=sim_spin_dynamics_arb8(params)

% Load parameters
tp=params.tp; pul=params.pul; Rtot=params.Rtot; amp=params.amp; acq=params.acq;
grad=params.grad; len_acq=params.len_acq; 
del_w=params.del_w; del_wg=params.del_wg;
