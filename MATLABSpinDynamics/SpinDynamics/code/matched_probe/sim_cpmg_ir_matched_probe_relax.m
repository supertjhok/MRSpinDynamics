...
function [echo_int_all]=sim_cpmg_ir_matched_probe_relax(NE,TE,tauvect,T1,T2)
...
for j=1:ntau % Parallelize for speed
    ...
    ppc.phi=[penc pexc+pi pref]; % Change phase  excitation pulse
...
%         echo_rx=zeros(NE,nacq);
        ...
        echo_int_all(j,i)=trapz(tvect,echo_rx(i,:));
    end
