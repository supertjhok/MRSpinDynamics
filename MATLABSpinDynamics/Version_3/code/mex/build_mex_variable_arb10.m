% BUILD_MEX_VARIABLE_ARB10
% Generate a variable-size MEX function for sim_spin_dynamics_arb10.
%
% Purpose
%   Builds a representative params structure, declares bounded variable-size
%   fields with coder.typeof, and runs codegen for the current arb10 numerical
%   kernel.
%
% Inputs
%   This script takes no function arguments. Example field sizes and upper
%   bounds are defined directly in the script.
%
% Outputs
%   Creates sim_spin_dynamics_arb10 MEX/codegen outputs locally.
%
% Key functions
%   coder.typeof, codegen, sim_spin_dynamics_arb10.
%
% Notes
%   Requires MATLAB Coder and a configured C/C++ compiler. Generated outputs are
%   ignored release artifacts. Review the field-size bounds before using this
%   script for large production simulations.
% -------------------------------------------------------------------------

% Example input structure fields include tp, pul, amp, acq, grad, Rtot,
% del_w, del_wg, w_1, T1n, T2n, m0, and mth.
npts=5e3;
% Rotation matrix
