...
% Optimize (SNR with AMEX and matched filtering) + (minimum v0,crit)
masy=conv(neff(1,:)+1i*neff(2,:),pp.window,'same'); % Filtering by acquisition window
...
v0crit_av=1e2./(trapz(del_w,1./v0crit));
