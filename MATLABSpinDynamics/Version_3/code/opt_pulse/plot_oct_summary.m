% PLOT_OCT_SUMMARY
% Summarize OCT optimization result files and generate comparison plots.
%
% Purpose
%   Loads optimized refocusing and excitation pulse result files for untuned,
%   tuned, and matched probe cases, compares them against rectangular-pulse
%   references, and plots SNR trends versus pulse length.
%
% Inputs
%   This script takes no function arguments. It expects optimization result
%   MAT-files named by the ref_* and exc_* filename patterns defined below.
%   Those files are local generated artifacts and are ignored by Git.
%
% Outputs
%   Creates SNR comparison figures and leaves SNR summary arrays in the
%   workspace.
%
% Key functions
%   plot_rot_rect_untuned, plot_rot_rect_tuned, plot_rot_rect_matched,
%   plot_opt_ref_results_untuned, plot_opt_ref_results_tuned,
%   plot_opt_ref_results_matched, plot_opt_exc_results_tuned.
%
% Notes
%   This script depends on local optimization result MAT-files. It is intended
%   for post-processing completed OCT runs, not as a standalone smoke test.
% -------------------------------------------------------------------------
%
