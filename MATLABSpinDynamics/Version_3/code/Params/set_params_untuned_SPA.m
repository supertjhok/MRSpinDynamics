...
function [params,sp,pp] = set_params_untuned_SPA
% Global parameters
% --------------------------------------------
sp.k = 1.381e-23; % J/K
...
% System parameters
% --------------------------------------------
sp.f0 = 8e6; % Target matching frequency (= Larmor frequency), Hz
sp.fin = 8e6; % Input frequency, Hz
sp.w0 = 2*pi*sp.fin;
pp.w = sp.w0;

% Coil parameters
% --------------------------------------------
sp.L = 10e-6*(1e6/sp.f0); % H
sp.Q = 50;
...
pp.tacq=[4]*pp.T_180; % Acquisition time for observing echo
