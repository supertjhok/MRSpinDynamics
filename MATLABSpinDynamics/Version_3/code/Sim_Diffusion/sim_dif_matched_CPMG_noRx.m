...
function [echo_rx,tvect]=sim_dif_matched_CPMG_noRx(NE,TE,T1,T2,dz,Delta,T_90,Q)
...
pp.pul = pp.tp;
% Run PAP phase cycle
[~,mrx1,~,~,~]=calc_macq_matched_probe_relax_diff_noRx(sp,pp);

pp.phi=[pexc+pi penc pref]; % Change phase of excitation pulse
[~,mrx2,~,~,~]=calc_macq_matched_probe_relax_diff_noRx(sp,pp);
