# Version 3 Benchmark Suite

This folder contains small MATLAB benchmarks for the active Version 3 numerical
...
- The runner adds `Version_3/code` and its subfolders to the
  MATLAB path.
