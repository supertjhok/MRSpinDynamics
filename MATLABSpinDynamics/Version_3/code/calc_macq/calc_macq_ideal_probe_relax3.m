...
function [macq,echo_rx,tvect]=calc_macq_ideal_probe_relax3(sp,pp)
...
% Create structure
params.tp=pp.tp; params.pul=pp.pul; params.amp=pp.amp; params.acq=pp.acq;
params.grad=pp.grad; params.Rtot=pp.Rtot;
params.len_acq=tacq; params.del_w=sp.del_w; params.del_wg=sp.del_wg;
params.w_1=sp.w_1;
...
for i=1:nacq
    ...
    [echo_rx(i,:),tvect]=calc_time_domain_echo_arb(macq(i,:),sp.del_w,tacq,tdw,sp.plt_echo);
end