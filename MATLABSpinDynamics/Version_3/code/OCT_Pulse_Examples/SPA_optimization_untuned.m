...
% Assuming a untuned probe

function [out] = SPA_optimization_untuned

[params,sp,pp] = set_params_untuned_SPA; % Define default system parameters
...
for i=1:num_rpulses
    ...
    [~,~,~,~,SNRr(i)] = plot_masy_arbref_untuned(params,sp,pp);
end
...
parfor i=1:num_pulses
    ...
    [~,~,~,~,SNR(i)] = plot_masy_arbref_untuned(params_curr,sp,pp);
end
