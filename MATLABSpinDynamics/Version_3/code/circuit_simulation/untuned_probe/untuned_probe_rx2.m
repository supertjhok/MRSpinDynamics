% Calculate receiver filtering function for an untuned probe (without
% an input transformer)

function [mrx,SNR,tf] = untuned_probe_rx2(sp,pp,macq)

k=sp.k; T=sp.T;
L=sp.L; R=sp.R; C=sp.C;
Cin=sp.Cin; Rin=sp.Rin; Rd=sp.Rd;
Rdup=sp.Rdup; % Duplexer
...
Zeff=(Zp+Rdup); % Effective source impedance
