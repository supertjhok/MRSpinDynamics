...
function [mrx,SNR,SNR_max] = calc_masy_tuned_probe_lp(params,sp,pp)
...
%sp.plt_tx=99;
[neff,SNR_max]=calc_rot_axis_tuned_probe_lp(params,sp,pp);
params.neff=neff;

% Create excitation pulse, including delays to allow pulse to ring down
