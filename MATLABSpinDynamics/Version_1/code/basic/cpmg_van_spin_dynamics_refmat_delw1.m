...
function [echo_pk,echo_rms]=cpmg_van_spin_dynamics_refmat_delw1(texc,pexc,T_90,del_w1,T_FP,refmat,delt)
...
[echo,tvect]=sim_spin_dynamics_refmat_delw1(T_90,del_w1,texc,pexc,tf,refmat);
