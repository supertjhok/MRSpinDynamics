...
function [texc,pexc,echo_pk,echo_rms]=opt_exc_pulse_refmat(nseg,T_90,T_FP,refmat,delt,start)
...
texc=fmincon(@(params)fit_function(params,pexc,T_90,T_FP,refmat,delt),start,[],[],[],[],lb,ub,[],options);
...
function val=fit_function(texc,pexc,T_90,T_FP,refmat,delt)
