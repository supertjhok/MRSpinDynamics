...
function [texc,pexc,echo_pk,echo_rms]=opt_exc_pulse_asymp_mag9(pulse_num,NE,len_acq,T1,T2)
...
pexc=fmincon(@(params)fit_function...
    (params,texc,aexc,tref,pref,aref,NE,len_acq,T1,T2),start,[],[],[],[],lb,ub,[],options);
...
function val=fit_function(pexc,texc,aexc,tref,pref,aref,NE,len_acq,T1,T2)
