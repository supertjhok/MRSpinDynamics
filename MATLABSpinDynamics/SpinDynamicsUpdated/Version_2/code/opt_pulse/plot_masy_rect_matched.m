...
% function [masy,SNR] = plot_masy_rect_matched(vars)
% vars: len - normalized 90 pulse length, rat - ref/exc pulse ratio

function [mrx,masy,echo_rx,tvect,SNR] = plot_masy_rect_matched(vars)
...
% (relative to T_90)
pp.texc = pp.T_90*vars.len;
pp.tref(2) = pp.texc*vars.rat;
