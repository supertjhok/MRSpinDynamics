...
% ensembles. Find magnetization after a given excitation pulse.
% ------------------------------------
...
% Rewritten to report magnetization after the refocusing pulse: 03/26/21

function [mvect]=sim_spin_dynamics_exc(tp,phi,amp,del_w)
