# Version 3 Workflow Map

This page maps the active MATLAB implementation under
`Version_3/code`. It is intended as the first place to look
...
- Many same-named functions exist in older folders. Prefer the active
  `Version_3` copy unless a legacy comparison is explicitly needed.
- Some scripts are exploratory and should be reviewed before being treated as
  polished public workflows.
- MEX build scripts are tracked, but generated MEX/codegen artifacts are ignored
  and should be rebuilt locally.
