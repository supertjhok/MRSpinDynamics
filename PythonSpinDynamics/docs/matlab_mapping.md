...
| `Wurst_Inversion` | `spin_dynamics.pulses`, `spin_dynamics.probes.matched`, `spin_dynamics.workflows.wurst` | WURST pulse construction, matched-probe frequency-swept transmit response, ideal/matched inversion, and matched WURST-CPMG workflows. |
...
| WURST inversion/CPMG | `create_wurst_pulse`, `find_coil_current_wurst`, `matched_wurst_pulse_response`, `run_ideal_wurst_inversion`, `run_matched_wurst_inversion`, and `run_matched_wurst_cpmg` are available. |
