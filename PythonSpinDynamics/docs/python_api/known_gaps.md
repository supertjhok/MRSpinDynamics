...
The next natural migration targets are MATLAB result-file compatibility,
broader optimization parity validation, and stronger inverse-excitation
workflows, with additional diffusion validation as a parallel track.
