...
The bundled glycine structure is CCDC~189379, space group \code{P 21}.  This
...
bonds, so the exploratory run used \code{pawovlp 25}; production calculations
...
\textbf{Reliability checklist.} Before using these couplings as design numbers,
repeat the workflow with converged \code{ecut}, \code{pawecutdg}, and
\code{ngkpt}; relax at least the hydrogen positions or use a neutron-quality
structure; verify the symmetry-related nitrogen index~\code{11}; and remove or
quantify the effect of \code{pawovlp 25}.
